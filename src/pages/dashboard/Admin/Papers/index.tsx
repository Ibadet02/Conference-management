...
const Papers = () => {
  ...
  useEffect(() => {
    ...
    setShownData(uniqueRows?.filter((row) => row.abstractApproved && row?.fileId &&
    !toBeReviewed?.some((e) => row.paperId === e.paperId)
))
    setArchivedData(uniqueRows?.filter((row) => row.abstractApproved && row?.fileId &&
    toBeReviewed?.some((e) => row.paperId === e.paperId)
))
  }, [submittedPapers])
                  ...
                  <RemoveRedEyeIcon />
                            ...
                            <td style={{ border: "1px solid #ccc" }}>
                              <Button
                                ...
                                variant="contained"
                              >
                                More Actions {row?.paperUpdateRequest && `(Update Requested)`}
                              </Button>
                            </td>
                          </tr>
                        );
                ...
                >
                  <RemoveRedEyeIcon />
                            ...
                            <td style={{ border: "1px solid #ccc" }}>
                              ...
                              >
                                More Actions <br/>
                               {row?.paperUpdateRequest && `(Update Requested)`}
                              </Button>
                            </td>
                          </tr>
                        );
